...
async def help_command(message:Message):
    await message.answer("Botimizni ishlatmoqchi bo`lsangiz. Birorta rus yoki inglizcha so'z yozing.\n Bu bot uni uzbekchaga tarjima qilib beradi")


@dp.message(Command("about"))
async def about_commands(message:Message):
    await message.answer("Bu bot sifat uquvchilri tomonidan yaratilgan!")
